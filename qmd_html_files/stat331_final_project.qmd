...
rsquared_values <- numeric(num_simulations)
residual_std_error <- sd(residuals(gdp_income_model))

for (i in 1:num_simulations) {
  random_errors <- rnorm(length(predictions), 0, residual_std_error)
  simulated_data <- predictions + random_errors
...
hist(rsquared_values, main = "Distribution of R-squared Values",
     xlab = "R-squared", col = "slateblue", breaks = 20)
```